...
function DataTable<T>({ columns, data, emptyMessage = 'No data' }: DataTableProps<T>) {
  if (data.length === 0) {
...
function BalanceChart({ dailyBalances, height = 160 }: BalanceChartProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-bw-200 shadow-card overflow-hidden">
      ...
      <div className="px-5 py-4 border-b border-bw-200">
        <BalanceChart dailyBalances={dailyBalances} height={160} />
